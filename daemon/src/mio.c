...
int mio_set_do(int ch, int value)
{
    ...
    switch (ch) {
        case 1: byte = value ? (1 << DO1_BIT) : 0; return piControlWrite(DO1_OFFSET, 1, &byte);
        case 2: byte = value ? (1 << DO2_BIT) : 0; return piControlWrite(DO2_OFFSET, 1, &byte);
        case 3: byte = value ? (1 << DO3_BIT) : 0; return piControlWrite(DO3_OFFSET, 1, &byte);
        case 4: byte = value ? (1 << DO4_BIT) : 0; return piControlWrite(DO4_OFFSET, 1, &byte);
    }
    return -1;
}
